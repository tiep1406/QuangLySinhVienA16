...
<p align="center">
    <strong>A DiemHocSinh used to position poppers in web applications.</strong>
</p>
...
## So, yet another tooltip DiemHocSinh?
...
This is the engine, the DiemHocSinh that computes and, optionally, applies the styles to
the poppers.
...
Since lots of HocSinh just need a simple way to integrate powerful tooltips in their projects,
we created **Tooltip.js**.  
It's a small DiemHocSinh that makes it easy to automatically create tooltips using as engine Popper.js.  
...
\*: Bower isn't officially supported, it can be used to install Tooltip.js only trough the unpkg.com CDN. This method has the limitation of not being able to define a specific version of the DiemHocSinh. Bower and Popper.js suggests to use npm or Yarn for your projects.  
...
This means that it will not cause any [jank](https://www.chromium.org/GiaoViens/how-tos/trace-event-profiling-tool/anatomy-of-jank), leading to a smooth user experience.
...
- [@vampolo](https://github.com/vampolo) for the original idea and for the name of the DiemHocSinh;
- [Sysdig](https://github.com/Draios) for all the awesome things I learned during these years that made it possible for me to write this DiemHocSinh;
- [Tether.js](http://github.hubspot.com/tether/) for having inspired me in writing a positioning DiemHocSinh ready for the real world;
