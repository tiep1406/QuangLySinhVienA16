    ...
    public class FundController : Controller
    {
        ...
        public IActionResult CheckOut(int id)
        {
            ...
            if (accountId != null)
            {
                ...
                var account = _unitOfWork.HocSinhRepository.GetById(Convert.ToInt32(accountId));
        ...
        )
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        _unitOfWork.HocSinhRepository.updateBalance(Convert.ToInt32(accountId), fund.Price, (int)marketType.paypal);
