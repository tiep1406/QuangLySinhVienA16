...
namespace QLSV.Areas.Admin.Controllers
{
    ...
    public class QLLichController : Controller
    {
        ...
        public QLLichController(IUnitOfWork unitOfWork, INotyfService notyfService, GameStoreDbContext context)
        {
        ...
        public async Task<IActionResult> Edit([Bind("thoiGian")] LichHoc hocsinh)
        {
            try
            {
